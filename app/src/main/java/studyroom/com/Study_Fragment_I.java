...
public class Study_Fragment_I extends Fragment {
    View view;
    ...
    public Study_Fragment_I() {

    }


    public static Study_Fragment_I newInstance() {
        Study_Fragment_I study_fragment_a = new Study_Fragment_I();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        databaseReference=database.getReference("교육").child("Python");
