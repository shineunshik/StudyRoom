...
public class Study_Fragment_B extends Fragment {
    View view;
    ...
    public Study_Fragment_B() {

    }


    public static Study_Fragment_B newInstance() {
        Study_Fragment_B study_fragment_a = new Study_Fragment_B();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        databaseReference=database.getReference("교육").child("Spring Boot");
