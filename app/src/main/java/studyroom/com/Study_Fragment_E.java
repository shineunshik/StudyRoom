...
public class Study_Fragment_E extends Fragment {
    View view;
    ...
    public Study_Fragment_E() {

    }


    public static Study_Fragment_E newInstance() {
        Study_Fragment_E study_fragment_a = new Study_Fragment_E();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        databaseReference=database.getReference("교육").child("JavaScript");
