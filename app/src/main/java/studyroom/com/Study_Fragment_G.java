...
public class Study_Fragment_G extends Fragment {
    View view;
    ...
    public Study_Fragment_G() {

    }


    public static Study_Fragment_G newInstance() {
        Study_Fragment_G study_fragment_a = new Study_Fragment_G();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        databaseReference=database.getReference("교육").child("C");
