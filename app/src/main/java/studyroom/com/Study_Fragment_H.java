...
public class Study_Fragment_H extends Fragment {
    View view;
    ...
    public Study_Fragment_H() {

    }


    public static Study_Fragment_H newInstance() {
        Study_Fragment_H study_fragment_a = new Study_Fragment_H();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        databaseReference=database.getReference("교육").child("HTML");
