...
public class Study_Fragment_D extends Fragment {
    View view;
    ...
    public static Study_Fragment_D newInstance() {
        Study_Fragment_D study_fragment_a = new Study_Fragment_D();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        databaseReference=database.getReference("교육").child("Java");
