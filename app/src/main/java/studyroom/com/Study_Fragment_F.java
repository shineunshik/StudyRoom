...
public class Study_Fragment_F extends Fragment {
    View view;
    ...
    public Study_Fragment_F() {

    }


    public static Study_Fragment_F newInstance() {
        Study_Fragment_F study_fragment_a = new Study_Fragment_F();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        databaseReference=database.getReference("교육").child("Node");
