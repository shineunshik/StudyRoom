...
public class Mento_Fragment extends Fragment {
    View view;
    ...
    public static Mento_Fragment newInstance() {
        Mento_Fragment study_fragment_a = new Mento_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        databaseReference=database.getReference("교육").child("멘토");
